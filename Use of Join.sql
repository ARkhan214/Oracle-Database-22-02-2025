...
-- Use of USING JOIN clause

SELECT first_name||' '||last_name AS "Full Name", salary, department_name
FROM employees JOIN departments
USING (department_id);

-- Use of JOIN ON clause (This is the most common and popular clause)
